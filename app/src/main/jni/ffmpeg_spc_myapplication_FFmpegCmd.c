...
#include "ffmpeg_spc_myapplication_FFmpegCmd.h"
#include <string.h>
...
void callJavaMethod(JNIEnv *env, jclass clazz,int ret) {
    ...
    //获取方法ID ()V指的是方法签名 通过javap -s -public ffmpeg.spc.myapplication.FFmpegCmd 命令生成
...
JNICALL Java_ffmpeg_spc_myapplication_FFmpegCmd_exec
